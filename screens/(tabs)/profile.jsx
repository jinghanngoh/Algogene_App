    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.sectionContainer}>
                ...
                <ProfileField label="User Name:" input={<TextInput style={styles.inputField} />} />
                <ProfileField label="Password:" input={<TextInput style={styles.inputField} secureTextEntry />} />
