...
# watchlist_data = {
#     "BTCUSD": {"previous_price": None, "current_price": None, "change_percent": None},
#     "ETHUSD": {"previous_price": None, "current_price": None, "change_percent": None}
# }
...
#     logging.info("Received Ctrl+C, shutting down...")
#     running = False
#     # Save watchlist data to a file before exiting
...
#     # Calculate percentage change (assuming previous price is available; here we use a placeholder)
#     previous_price = getattr(ws, 'previous_price', mid_price)
#     change_percent = ((mid_price - previous_price) / previous_price * 100) if previous_price else 0
#     ws.previous_price = mid_price
    
#     # Log watchlist update
#     logging.info(f"Watchlist update: {data['symbol']} - Price: {mid_price:.2f}, Change: {change_percent:.2f}%")
...
# #             if symbol in watchlist_data and bid_price is not None and ask_price is not None:
# #                 # Calculate mid price
# #                 current_price = (bid_price + ask_price) / 2
# #                 # Update watchlist data
# #                 if watchlist_data[symbol]["previous_price"] is None:
# #                     watchlist_data[symbol]["previous_price"] = current_price
# #                 else:
# #                     watchlist_data[symbol]["previous_price"] = watchlist_data[symbol]["current_price"]
# #                 watchlist_data[symbol]["current_price"] = current_price
# #                 # Calculate percentage change
...
# #                                 "change_percent": round(watchlist_data[symbol]["change_percent"], 2)
# #                                 if watchlist_data[symbol]["change_percent"] is not None
# #                                 else None,
